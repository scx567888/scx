...
public class MultiPartStreamCached2 implements MultiPart, Iterator<MultiPartPart> {
    ...
    public MultiPartStreamCached2(InputStream inputStream, String boundary, Path cachePath) {
