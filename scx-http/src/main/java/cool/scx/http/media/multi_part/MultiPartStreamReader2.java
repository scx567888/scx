...
public class MultiPartStreamReader2 implements MediaReader<MultiPart> {

    public static final MultiPartStreamReader2 MULTI_PART_READER = new MultiPartStreamReader2();
    ...
    public MultiPart read(InputStream inputStream, ScxHttpHeaders headers) {
        ...
        return new MultiPartStream2(inputStream, boundary);
    }
