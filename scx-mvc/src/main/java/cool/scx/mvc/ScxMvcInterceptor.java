...
public interface ScxMvcInterceptor {
     ...
     *
     * @param context ctx
     * @param handler ScxMappingHandler 实例
     * @throws java.lang.Exception 异常
     */
    default void preHandle(RoutingContext context, ScxRouteHandler handler) throws Exception {
     ...
     * @param handler 待处理的 scxMappingHandler
     ...
     */
    default Object postHandle(RoutingContext context, ScxRouteHandler handler, Object result) throws Exception {
        return result;
    }
