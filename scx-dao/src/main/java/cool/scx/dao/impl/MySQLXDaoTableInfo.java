 ...
 * @version 0.5.0
 */
public final class MySQLXDaoTableInfo implements TableInfo<MySQLXDaoColumnInfo> {
    ...
    private static void checkDuplicateColumnName(List<MySQLXDaoColumnInfo> list, Class<?> clazz) {
        var multiMap = new MultiMap<String, MySQLXDaoColumnInfo>();
        for (var info : list) {
