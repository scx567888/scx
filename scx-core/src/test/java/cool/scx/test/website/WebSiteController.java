...
public class WebSiteController {
    ...
    @ScxRoute(method = HttpMethod.POST)
    ...
    @ScxRoute(method = HttpMethod.GET)
     ...
     */
    @ScxRoute(value = "/", method = HttpMethod.GET, order = 10)
     ...
     */
    @ScxRoute(value = "/", method = HttpMethod.GET, order = 5)
     ...
     * @throws IOException a
     */
    @ScxRoute(value = "/*", method = HttpMethod.GET, order = 1)
     ...
     * @return a
     */
    @ScxRoute(value = "/baidu", method = HttpMethod.GET)
     ...
     * @return a
     */
    @ScxRoute(value = "/download", method = HttpMethod.GET)
     ...
     */
    @ScxRoute(value = "/raw", method = HttpMethod.GET)
     ...
     */
    @ScxRoute(value = "/md5", method = HttpMethod.GET)
     ...
     * @return a {@link BaseVo} object
     */
    @ScxRoute(value = "a", method = HttpMethod.GET)
    public BaseVo b() {
     ...
     * @return a {@link BaseVo} object
     */
    @ScxRoute(value = "/v/:aaa", method = {HttpMethod.GET, HttpMethod.POST})
    public BaseVo c() {
     ...
     * @return a {@link BaseVo} object
     */
    @ScxRoute(value = "/v/:bbb", method = HttpMethod.GET)
    public BaseVo d() {
