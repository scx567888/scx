...
import cool.scx.orm.jdbc.UpdateResult;
import cool.scx.orm.jdbc.result_handler.ResultHandler;
import cool.scx.orm.jdbc.sql.SQL;
import cool.scx.orm.test.bean.Student;
import cool.scx.orm.test.bean.StudentRecord;
...
import static cool.scx.orm.jdbc.result_handler.ResultHandler.ofMapList;
import static cool.scx.orm.jdbc.sql.SQL.ofNormal;
...
public class SQLRunnerTest {
    ...
    public static void test5() {
        ...
        //查询多个
        var ofMapList = sqlRunner.query(sql, ofMapList());
        System.out.println("ofMapList " + ofMapList.size());
        var ofMapList1 = sqlRunner.query(sql, ofMapList(LinkedHashMap::new));
