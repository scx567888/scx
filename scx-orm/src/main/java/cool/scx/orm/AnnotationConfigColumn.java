...
public class AnnotationConfigColumn implements ColumnMapping {
    ...
    public AnnotationConfigColumn(Field javaField) {
        ...
        if (column != null) {
            ...
            this.columnName = StringUtils.notBlank(column.columnName()) ? column.columnName() : CaseUtils.toSnake(javaField.getName());
            ...
            this.type = null;
            this.columnName = CaseUtils.toSnake(javaField.getName());
