...
import cool.scx.orm.jdbc.dialect.DialectSelector;
import cool.scx.orm.jdbc.spy.event.LoggingEventListener;
import cool.scx.orm.jdbc.spy.wrapper.ConnectionWrapper;
...
public class SpyDriver implements Driver {
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        return new ConnectionWrapper(realDriver.connect(realUrl, info), new LoggingEventListener(DialectSelector.findDialect(realDriver)));
    }
