...
public final class UpdateFilter extends AbstractFilter<UpdateFilter> {
    ...
    /**
     * 启用白名单模式 (当一个实体类所对应的 field 的值为 null 时, 会将此 field 所对应的列排除, 详情请看 {@link cool.scx.core.base.UpdateFilter#ofIncluded(boolean)})
     *
     * @return a
     */
    ...
    /**
     * 启用黑名单模式 (当一个实体类所对应的 field 的值为 null 时, 会将此 field 所对应的列排除, 详情请看 {@link cool.scx.core.base.UpdateFilter#ofExcluded(boolean)})
     *
     * @return a
     */
