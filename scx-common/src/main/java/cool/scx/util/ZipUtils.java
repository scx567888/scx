...
public final class ZipUtils {
    ...
    public static void zip(Path sourcePath, Path outputPath, ZipOption... zipOptions) throws IOException {
        ...
        try (var zos = new ZipOutputStream(Files.newOutputStream(outputPath))) {
            writeToZipOutputStream(sourcePath, zos, rootPath);
        }
    }
     ...
     */
    public static void writeToZipOutputStream(Path sourcePath, ZipOutputStream zos, String rootPath) throws IOException {
        //遍历目录
